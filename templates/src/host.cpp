...
void copy_input(std::vector<HostData, tapa::aligned_allocator<HostData>> input, 
		std::vector<std::vector<HostData, tapa::aligned_allocator<HostData> >, std::allocator<std::vector<HostData, tapa::aligned_allocator<HostData> > >> &X, int POLY_NUM){
...
int main(int argc, char* argv[]) {
    ...
    copy_input(input, X, ADJ_POLY_NUM);
    ...
    copy_output(Y, out_hw, ADJ_POLY_NUM);    
